...
var code_default = (0, import_react.memo)(({
  data,
  render,
  onLink
}) => {
  ...
  const tsx = data ? /* @__PURE__ */ import_react.default.createElement(
    ...
    elements.map((el, index) => /* @__PURE__ */ import_react.default.createElement("div", { "data-line-num": index + 1, key: index, className: "feishudocx-code-line" }, /* @__PURE__ */ import_react.default.createElement(import_text_element.default, { data: el, render, onLink })))
  ) : null;
