...
// src/FeishuDocxRender/components/heading4/index.tsx
var heading4_exports = {};
__export(heading4_exports, {
  default: () => heading4_default
});
...
var heading4_default = (0, import_react.memo)(({
  data,
  render,
  onLink
}) => {
  var _a, _b;
  const elements = ((_a = data == null ? void 0 : data.heading4) == null ? void 0 : _a.elements) || [];
  ...
  const tsx = data ? /* @__PURE__ */ import_react.default.createElement(
    "div",
    {
      ...
      className: (0, import_classnames.default)(
        "feishudocx-heading4",
        ...(0, import_utils.getTextStyle)(((_b = data.heading4) == null ? void 0 : _b.style) || {})
      )
    },
