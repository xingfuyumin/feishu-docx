...
// src/FeishuDocxRender/components/heading5/index.tsx
var heading5_exports = {};
__export(heading5_exports, {
  default: () => heading5_default
});
...
var heading5_default = (0, import_react.memo)(({
  data,
  render,
  onLink
}) => {
  var _a, _b;
  const elements = ((_a = data == null ? void 0 : data.heading5) == null ? void 0 : _a.elements) || [];
  ...
  const tsx = data ? /* @__PURE__ */ import_react.default.createElement(
    "div",
    {
      ...
      className: (0, import_classnames.default)(
        "feishudocx-heading5",
        ...(0, import_utils.getTextStyle)(((_b = data.heading5) == null ? void 0 : _b.style) || {})
      )
    },
