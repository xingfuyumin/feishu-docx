...
var import_latex = __toESM(require("../latex"));
...
var text_element_default = (0, import_react.memo)(({
  ...
  const tsx = data ? /* @__PURE__ */ import_react.default.createElement(
    ...
    /* @__PURE__ */ import_react.default.createElement(import_latex.default, { data: data == null ? void 0 : data.equation, render, onLink })
  ) : null;
