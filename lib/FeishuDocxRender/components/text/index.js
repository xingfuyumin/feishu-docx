...
// src/FeishuDocxRender/components/text/index.tsx
var text_exports = {};
...
var text_default = (0, import_react.memo)(({
  data,
  render,
  onLink
}) => {
  var _a, _b;
  const elements = ((_a = data == null ? void 0 : data.text) == null ? void 0 : _a.elements) || [];
  ...
  const tsx = data ? /* @__PURE__ */ import_react.default.createElement(
    "div",
    {
      ...
      className: (0, import_classnames.default)(
        "feishudocx-text",
        ...(0, import_utils.getTextStyle)(((_b = data.text) == null ? void 0 : _b.style) || {})
      )
    },
